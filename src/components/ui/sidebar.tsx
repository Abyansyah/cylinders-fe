...
const SidebarMenuContext = React.createContext<SidebarMenuContext | null>(null)
...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const menuContextValue = React.useMemo<SidebarMenuContext>(
    () => ({
      expandedGroup,
      setExpandedGroup,
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<"div"> & { id?: string }>(

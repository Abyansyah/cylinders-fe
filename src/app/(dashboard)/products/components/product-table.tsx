    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Link href="/products/import" className="focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 flex items-center font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">

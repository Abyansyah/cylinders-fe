...
import { FileText, Beaker, Package, Pencil, Calendar, Hash, ChevronLeft } from 'lucide-react';
...
export default async function ProductDetailPage(props: Props) {
  ...
  return (
    <PermissionGuard requiredPermission={PERMISSIONS.products.view}>
      <PageTransition>
        <div className="flex items-center justify-end sm:justify-between gap-y-10 mb-6 flex-wrap">
